  ...
  return  isEducator && (
    <div className='md:w-64 w-16 border-r min-h-screen text-base border-gray-500 py-2 flex flex-col'>
      {menuItems.map((item)=>(
        ...
        ${isActive ? 'bg-indigo-50 border-r-[6px] border-indigo-800/90 ': 'hover:bg-gray-100/90 borer-r-[6px] border-white hover:border-gray-100/90'}`}>
          <img src={item.icon} alr="" className='w-6 h-6'/>
