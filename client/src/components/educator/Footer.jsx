...
function Footer() {
  return (
    <footer className='flex md:flex-row flex-col-reverse items-center jusitfy-between text-left w-full px-8 border-t'>
      <div className='flex items-center gap-4'>
        ...
        <p className=' py-4 text-center text-xs md:text-sm text-gray-500'>
          CopyRight 2025 Morgan Ellary, All Rights Reserved
        </p>
        
      </div>
      <div className="flex items-center gap-3 ml-auto max-md:mt-4">
