...
import LoadingContent from './components/student/Loading'
...
import EducatorEditCourse from './pages/educators/EducatorEditCourse'
  ...
  return (
      ...
      <div className='text-default min-h-screen bg-white'>
        ...
        <Routes >
          ...
          <Route path='/player' element={<VidPlayer />}/>
        ...
        <Route path='/educator' element={<EducatorPage />}>
            ...
            <Route path='edit-course/:id' element={<EducatorEditCourse />}/>
          </Route>
